...
% Adaptation in time domain, using NLMS algorithm modified with Adaptive Crossterms
% 
% Aironi Carlo 2019
%---------------------------------------
...
LS = (2*LH + N)/2;              % Length of subband adapted filters (according to Gilloire/Vetterli formula)
...
[c00,c01,c10,c11,e0,e1] = nlms_cross_dual(v0_f,v1_f,v0_d,v1_d,step,beta,LS); % nlms_cross 2 bands

toc                             % timer

etot = qmfs(e0,e1,g0,g1);        % Synthesis
...
title('Output error with crossterms');
